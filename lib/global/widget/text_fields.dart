          ...
          decoration: InputDecoration(
            enabledBorder: OutlineInputBorder(
              ...
              borderSide: BorderSide(
                color: KColor.softGrey.color.withOpacity(.50),
              ),
            ),
...
InputDecoration buildInputDecoration(
  ...
  return InputDecoration(
      ...
      suffixIcon: isDateField || isPassword
          ? isPassword
              ? IconButton(
                  onPressed: () {
                    onVisiblePressed!();
      ...
      prefixIcon: icon != null && !isDateField
          ...
          : null,
      hintStyle: TextStyle(color: KColor.softGrey.color.withOpacity(.5)),
      label: label == null || isDateField || isDropdownField
          ? null
          : Row(
      ...
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12.0),
        borderSide: BorderSide(color: KColor.softGrey.color.withOpacity(.50)),
      ),
      errorBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12.0),
